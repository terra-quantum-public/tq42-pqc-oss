...
def test_asymmetric_container(pqc):
    ...
    # asymmetric cipher: McEliece, rainbow.
...
def test_asymmetric_container_file_io(pqc):
    ...
    pqc.PQC_asymmetric_container_save_as(
        ...
        new_container,
        "test_asymmetric_container_file_io",
        "client",
        "device1",
        "password",
        "salt",
    ...
    resultContainer = pqc.PQC_asymmetric_container_open(
        pqc.PQC_CIPHER_MCELIECE, "test_asymmetric_container_file_io", "client", "device1", "password", "salt"
    )
...
def test_asymmetric_container_file_delete(pqc):
    ...
    pqc.PQC_asymmetric_container_save_as(
        pqc.PQC_CIPHER_MCELIECE,
        new_container,
        "test_asymmetric_container_file_delete",
        "client",
        "device1",
        "password",
        "salt",
    ...
    pqc.PQC_asymmetric_container_close(new_container)
    pqc.PQC_asymmetric_container_delete("test_asymmetric_container_file_delete", "client", "device1")
