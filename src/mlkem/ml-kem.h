...
template <size_t MODE> class MLKEMContext : public KEMContext
{
public:
    MLKEMContext(const ConstBufferView & public_key, const ConstBufferView & private_key)
...
template <size_t MODE> class MLKEMFactory : public AlgorithmFactory
{
public:
